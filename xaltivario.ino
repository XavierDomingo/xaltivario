...
int speaker = 9;                       //arduino speaker output +
...
#define SAMPLES_ARR 60                  //define moving average filter array size (2->30), more means vario is less sensitive and slower, NMEA output
#define UART_SPEED 9600                //define serial transmision speed (9600,19200, etc...)
#define PROTOCOL 1                     //define NMEA output: 1 = $LK8EX1, 2 = FlymasterF1
#define NMEA_LED_pin 10                 // LED NMEA out pin (remember pin Arduino digital pin 6 is not Atmega 328 pin 6)
...
static const byte Digits[][4][18] = 
{
 { //0
  ...
  { //10 es vacio
    ...
    { // 11 es -
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
    { 0x00, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0x00 },  
    { 0x00, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x00 }, 
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
  },
  { // 12 es +
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
    { 0x00, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xE0, 0xE0, 0xE0, 0xE0, 0xE0, 0x00 },  
    { 0x00, 0x03, 0x03, 0x03, 0x03, 0x03, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x03, 0x03, 0x03, 0x03, 0x03, 0x00 }, 
    { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 },
  }
};

static const byte SecondIndicator[4] =   // indicador decimal forma
{
 0x00, 0x00, 0x00, 0x60
...
void Point(byte row)  //dibuja un separador decimal
{
  Spacer();  
  for(int PointSegment = 0; PointSegment < 3; PointSegment++)
  {
...
void setup()                // setup() function to setup all necessary parameters before we go to endless loop() function
{
  ...
  LcdClear();
  gotoXY(0,0);
  LcdString("Xaltivario");
  gotoXY(0,1);
  LcdString("v0.1");
  gotoXY(0,2);
  LcdString("4-may-2012");
  gotoXY(0,3);
  LcdString("EXPERIMENTAL");
  gotoXY(0,4);
  LcdString("USE AT YOUR OWN RISK");
